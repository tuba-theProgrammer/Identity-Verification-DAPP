...
class FileCertificatorPage extends Component {
  ...
  console.log("count",this.state.accountHistory.length)
          ...
          <Card className={"listItemTx"}  key={key}>
            <CardBody>
              <div className={"cardBodyCont"}>
                ...
                <p className={"historyTxDataPnt"}><span role="img" aria-label="asd">📦</span> Author: <b>{interaction.returnValues.author} </b></p>
                  ...
                  <p className={"historyTxDataPnt"}><span role="img" aria-label="asd">📒</span> Blockchain Transaction ID: 
                  <b>{transactionID}</b></p>
                  <div>
  ...
  render() {
    ...
    return (
      ...
      <div className={"globalCont"} justify="center">
        <section>
          <div id={"heroTitles"}>
            <h1 className={"mainh1title"}>Decentralized Identity Verification</h1>
          ...
          <div id="fileUplCont">
            ...
            <p className={"tutorialParags"}>Select the file that you want to certify</p>
            </div>
